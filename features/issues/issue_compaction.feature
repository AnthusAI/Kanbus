Feature: Issue Compaction
  ...
  Scenario: Running the summarize subcommand for an active issue
    ...
    And the summary comment for issue "kanbus-compaction01" should contain "Action Items"
    And the summary comment for issue "kanbus-compaction01" should contain "Current State"
  ...
  Scenario: Running the summarize subcommand for an archived issue
    ...
    And the summary comment for issue "kanbus-compaction02" should contain "Results"
    And the summary comment for issue "kanbus-compaction02" should contain "Impact"
