...
@given('a beads issue "{identifier}" exists with status "{status}" and updated_at "{updated_at}"')
...
@then('beads issues.jsonl should contain exactly {count:d} records with id "{identifier}"')
