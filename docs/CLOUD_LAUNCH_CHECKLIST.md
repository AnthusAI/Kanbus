...
- [ ] Live sync worker updates tenant EFS repo and publishes IoT event (requires egress design; isolated worker cannot reach GitHub/IoT without NAT or endpoints).
